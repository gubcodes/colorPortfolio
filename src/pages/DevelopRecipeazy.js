...
function DevelopRecipeazy() {
  const image = 'recipeazy';
  const title = 'RECIPEAZY';
  const url = 'https://group-4-recipeazy-client.herokuapp.com/';
    ...
    <div className="w-screen grid-cols-12 text-center tuffyBold tracking-widest">
      ...
      <div className={`card bg-contain ${image}-XS sm:${image}-SM md:${image}-MD lg:${image}-LG xl:${image}-XL`}>
        ...
        <div className="text-lg pb-5 ml-5 mr-5 tracking-wide">
          {/* description here */}
          MY FIRST FULL-STACK PROJECT AT EFA - A WEEK-LONG GROUP EFFORT.<br/><br/>A PERN STACK SHOPPING LIST APP UTILIZING EDAMAME'S RECIPE SEARCH API. MY FIRST TIME WORKING WITH REACT AND USING TEAM GIT FOR VERSION CONTROL.
        </div>
...
export default DevelopRecipeazy;